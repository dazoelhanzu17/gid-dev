					...
					<form action="{{ $route }}" method="POST" enctype="multipart/form-data">
									...
									<fieldset class="mb-3">
											...
											<div class="form-group row">
												...
												<div class="col-lg-10">
													<input type="text" name="title" class="form-control" value="{{ $page->pages_name ?? "" }}">
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-lg-10">
														<textarea name="content" id="editor-full" rows="4" cols="4">{{ $page->pages_desc ?? "" }}</textarea>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-lg-10">
														<textarea name="content_eng" id="" rows="4" cols="4">{{ $page->pages_desc_eng ?? "" }}</textarea>
												</div>
											</div>
