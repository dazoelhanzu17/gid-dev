...
class PhotoGalleryController extends Controller
{
    ...
    public function index()
    {
        ...
        if(get_role(Auth::user()->id_user_group) != 'FALSE'){
            ...
            return view('photogallery::index')
                    ->with('album_photos', AlbumPhoto::paginate(10))
                    ->with('role', $role);
        }else{
    ...
    public function galery_store(Request $request, $id){
        ...
        $thumbnailPath  = public_path().'/images/image_galleries/thumbnail/';
        $originalPath   = public_path().'/images/image_galleries/images/';
