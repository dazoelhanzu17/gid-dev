...
<div class="banner">
		<div class="banner_background" style="background-image:url(frontend_assets/images/banner_background.jpg'"></div>
		<div class="container fill_height">
			<div class="row fill_height">
				<div class="banner_product_image"><img src="frontend_assets/images/banner_product.png'" alt=""></div>
