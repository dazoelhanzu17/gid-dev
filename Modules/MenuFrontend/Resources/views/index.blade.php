												...
												<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(142px, 36px, 0px);">
													...
													<div class="dropdown-submenu">
															...
															<div class="dropdown-menu">
																<p onclick="openLink('{{ route('cms.frontendmenus.to_filecategories') }}','File Kategori','700','500', '31')"  class="dropdown-item">File Kategori</p>
																<p onclick="openLink('{{ route('cms.frontendmenus.to_photoalbum') }}','Photo Album','700','500', '32')"  class="dropdown-item">Photo Album</p>
																<p onclick="openLink('{{ route('cms.frontendmenus.to_videos') }}','Video','700','500', '33')"  class="dropdown-item">Video</p>
