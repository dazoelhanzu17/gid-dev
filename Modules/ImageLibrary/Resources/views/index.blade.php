					...
					<div class="card-body">
							...
							<div class="row text-center text-lg-left">
								...
								<div class="col-lg-2 col-md-4 col-6" onmouseover="extraBtn('show', {{$image->id}})" onmouseout="extraBtn('hide', {{$image->id}})">
										...
										<img class="img-fluid img-thumbnail" src="{{ asset('images/media/thumbnail/'.$image->file_name) }}" alt="">
										...
										<a href="{{ asset('images/media/thumbnail/'.$image->file_name) }}" class="d-block fancybox mr-2" rel="ligthbox"><i class="icon-zoomin3"></i> </a>
									...
									<form method="POST" id="deletePhoto" action="{{ route('cms.imagelibrary.delete', ['id' => $image->id]) }}" style="float:left;margin-right: 10px;">
										...
										<input type="hidden" value="{{ asset('images/media/thumbnail/'.$image->file_name) }}" id="link{{ $image->id }}">
